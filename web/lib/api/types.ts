...
export type CreatorListItem = Schemas["CreatorListItem"];
export type CreatorListView = Schemas["CursorPage_CreatorListItem"];
...
export type OcrRegion = Schemas["OcrRegion"];
export type OcrRequest = Schemas["OcrRequest"];
export type OcrResponse = Schemas["OcrResponse"];
export type OcrWord = Schemas["OcrWord"];
export type TextRegionView = Schemas["TextRegionView"];
export type TextRegionsView = Schemas["TextRegionsView"];
export type ServerInfoView = Schemas["ServerInfoView"];
export type RestartPendingView = Schemas["RestartPendingView"];
export type RestartPendingItem = Schemas["RestartPendingItem"];
...
export type HealthIssuesPage = Schemas["HealthIssuesPage"];
export type HealthIssueCounts = Schemas["HealthIssueCounts"];
export type HealthIssueKindFacet = Schemas["HealthIssueKindFacet"];
...
export type DeadJobsPurgeReq = Schemas["DeadJobsPurgeReq"];
export type DeadJobsPurgeResp = Schemas["DeadJobsPurgeResp"];
...
export type CreateUserReq = Schemas["CreateUserReq"];
export type CreateUserResp = Schemas["CreateUserResp"];
...
export type CblBulkItemView = Schemas["CblBulkItemView"];
export type CblBulkResultView = Schemas["CblBulkResultView"];
...
export type AppearanceView = Schemas["AppearanceView"];
export type AppearancesView = Schemas["AppearancesView"];
...
export type CollectionReportView = Schemas["CollectionReportView"];
...
export type ProviderBudget = Schemas["ProviderBudget"];
export type BatchListResp = Schemas["BatchListResp"];
export type BatchListRow = Schemas["BatchListRow"];
export type BatchApplyResp = Schemas["BatchApplyResp"];
export type MetadataOverviewView = Schemas["MetadataOverviewView"];
export type FieldProvenanceRow = Schemas["FieldProvenanceRow"];
...
export type RecentAppliesResp = Schemas["RecentAppliesResp"];
