...
[`web/lib/selection/use-selection.ts`](https://github.com/mbryantms/folio/blob/main/web/lib/selection/use-selection.ts).
...
[`web/tests/selection/use-selection.test.ts`](https://github.com/mbryantms/folio/blob/main/web/tests/selection/use-selection.test.ts).

### `<SelectionToolbar>`

[`web/components/library/SelectionToolbar.tsx`](https://github.com/mbryantms/folio/blob/main/web/components/library/SelectionToolbar.tsx).
...
[`web/components/library/SelectionCheckbox.tsx`](https://github.com/mbryantms/folio/blob/main/web/components/library/SelectionCheckbox.tsx).
...
existing [`useCoverLongPressActions`](https://github.com/mbryantms/folio/blob/main/web/components/CoverLongPressActions.tsx)
...
[`web/lib/api/mutations.ts`](https://github.com/mbryantms/folio/blob/main/web/lib/api/mutations.ts) for
unit-testing — see
[`web/tests/api/bulk-progress-summary.test.ts`](https://github.com/mbryantms/folio/blob/main/web/tests/api/bulk-progress-summary.test.ts).
